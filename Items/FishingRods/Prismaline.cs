...
{
    public class Prismaline : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<PrismBobber>(); // The bobber projectile. Note that this will be overridden by Fishing Bobber accessories if present, so don't assume the bobber spawned is the specified projectile. https://terraria.wiki.gg/wiki/Fishing_Bobbers
        }
        ...
        {
            int bobberAmount = 5;
            float spreadAmount = 50f; // how much the different bobbers are spread out.
        ...
        public override void ModifyFishingLine(Projectile bobber, ref Vector2 lineOriginOffset, ref Color lineColor)
        {
            ...
            if (bobber.ModProjectile is PrismBobber prismBobber)
            {
                // ExampleBobber has custom code to decide on a line color.
                lineColor = prismBobber.FishingLineColor;
            }
            else
            {
