...
{
    public class GoldfishingRod : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<GoldfishBobber>(); // The bobber projectile. Note that this will be overridden by Fishing Bobber accessories if present, so don't assume the bobber spawned is the specified projectile. https://terraria.wiki.gg/wiki/Fishing_Bobbers
        }
        ...
        public override void ModifyFishingLine(Projectile bobber, ref Vector2 lineOriginOffset, ref Color lineColor)
        {
            ...
            if (bobber.ModProjectile is GoldfishBobber goldfishBobber)
            {
                // ExampleBobber has custom code to decide on a line color.
                lineColor = goldfishBobber.FishingLineColor;
            }
            else
            {
