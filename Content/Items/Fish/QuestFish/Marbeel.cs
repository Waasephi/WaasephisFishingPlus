...
namespace WaasephisFishingPlus.Content.Items.Fish.QuestFish
{
    public class Marbeel : ModItem
    {
		...
		{
			description = Language.GetTextValue("Mods.WaasephisFishingPlus.AnglerQuest.Marbeel.Description");
			catchLocation = Language.GetTextValue("Mods.WaasephisFishingPlus.AnglerQuest.Marbeel.CatchLocation");
		}
	}
}