...
namespace WaasephisFishingPlus.Content.Items.Fish.QuestFish
{
    public class AetherianAngler : ModItem
    {
		...
		{
			description = Language.GetTextValue("Mods.WaasephisFishingPlus.AnglerQuest.AetherianAngler.Description");
			catchLocation = Language.GetTextValue("Mods.WaasephisFishingPlus.AnglerQuest.AetherianAngler.CatchLocation");
		}
	}
}