...
{
    public class GlassAnomalocaris : ModItem
    {
		...
		public override bool IsAnglerQuestAvailable() => NPC.downedBoss2;

		public override void AnglerQuestChat(ref string description, ref string catchLocation)
		{
			description = Language.GetTextValue("Mods.WaasephisFishingPlus.AnglerQuest.GlassAnomalocaris.Description");
			catchLocation = Language.GetTextValue("Mods.WaasephisFishingPlus.AnglerQuest.GlassAnomalocaris.CatchLocation");
		}
	}
}