...
namespace WaasephisFishingPlus.Content.Items.Fish.QuestFish
{
    public class HellstoneSnail : ModItem
    {
		...
		{
			description = Language.GetTextValue("Mods.WaasephisFishingPlus.AnglerQuest.HellstoneSnail.Description");
			catchLocation = Language.GetTextValue("Mods.WaasephisFishingPlus.AnglerQuest.HellstoneSnail.CatchLocation");
		}
	}
}