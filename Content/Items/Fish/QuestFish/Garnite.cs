...
namespace WaasephisFishingPlus.Content.Items.Fish.QuestFish
{
    public class Garnite : ModItem
    {
		...
		{
			description = Language.GetTextValue("Mods.WaasephisFishingPlus.AnglerQuest.Garnite.Description");
			catchLocation = Language.GetTextValue("Mods.WaasephisFishingPlus.AnglerQuest.Garnite.CatchLocation");
		}
	}
}