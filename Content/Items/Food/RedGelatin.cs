...
namespace WaasephisFishingPlus.Content.Items.Food
{
    public class RedGelatin : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToFood(22, 22, BuffID.WellFed, 14400);
        ...
        {
            player.AddBuff(ModContent.BuffType<MinorRegenerationBuff>(), 7200);
        }
	}
}