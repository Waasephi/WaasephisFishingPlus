...
{
	public class GlassCandelabrolacaris : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(178, 218, 253), Lang.GetItemName(ItemID.Candelabra));
			DustType = DustID.Glass;
			HitSound = SoundID.Shatter;
			RegisterItemDrop(ModContent.ItemType<GlassCandelabrolacarisItem>());
		...
		{
			GlowTexture ??= ModContent.Request<Texture2D>("WaasephisFishingPlus/Content/Tiles/Decor/GlassCandelabrolacarisGlow");
