...
{
	[LegacyName("ShellstoneChest2")]
	[LegacyName("ShellstoneChest3")]
	[LegacyName("ShellstoneChest4")]
	public class ShellstoneChest : ModTile
	{
		public sealed override void SetStaticDefaults()
		{
			...
			RegisterItemDrop(ModContent.ItemType<ShellstoneChestItem>());
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<ShellstoneChestItem>();
