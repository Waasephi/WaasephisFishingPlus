...
{
	public class ShellstoneDresser : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(83, 89, 104), this.GetLocalization("MapEntry"), MapChestName);
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconText = "Shellstone Dresser";
				}
				if (player.cursorItemIconText == "Shellstone Dresser")
				{
					player.cursorItemIconID = ModContent.ItemType<ShellstoneDresserItem>();
