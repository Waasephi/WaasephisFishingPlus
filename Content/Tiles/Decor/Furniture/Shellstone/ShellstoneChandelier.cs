...
{
	public class ShellstoneChandelier : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(83, 89, 104), Language.GetText("MapObject.Chandelier"));
			RegisterItemDrop(ModContent.ItemType<ShellstoneChandelierItem>());
		...
		{
			GlowTexture ??= ModContent.Request<Texture2D>("WaasephisFishingPlus/Content/Tiles/Decor/Furniture/Shellstone/ShellstoneChandelierGlow");
