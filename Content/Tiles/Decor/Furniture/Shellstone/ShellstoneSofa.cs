...
{
	public class ShellstoneSofa : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(83, 89, 104), Lang.GetItemName(ItemID.Sofa));
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<ShellstoneSofaItem>();
