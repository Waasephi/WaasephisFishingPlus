...
{
	public class ShellstoneCandelabra : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(83, 89, 104), Lang.GetItemName(ItemID.Candelabra));
			DustType = DustID.Cobalt;
			HitSound = SoundID.Tink;
			RegisterItemDrop(ModContent.ItemType<ShellstoneCandelabraItem>());
		...
		{
			GlowTexture ??= ModContent.Request<Texture2D>("WaasephisFishingPlus/Content/Tiles/Decor/Furniture/Shellstone/ShellstoneCandelabraGlow");
