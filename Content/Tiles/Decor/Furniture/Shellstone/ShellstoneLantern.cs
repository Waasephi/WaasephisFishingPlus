...
{
	public class ShellstoneLantern : ModTile
	{
		...
		{
			GlowTexture ??= ModContent.Request<Texture2D>("WaasephisFishingPlus/Content/Tiles/Decor/Furniture/Shellstone/ShellstoneLanternGlow");
