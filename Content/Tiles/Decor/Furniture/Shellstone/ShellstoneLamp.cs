...
{
	public class ShellstoneLamp : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(83, 89, 104), Language.GetText("MapObject.FloorLamp"));
			DustType = DustID.Cobalt;
			HitSound = SoundID.Tink;
			RegisterItemDrop(ModContent.ItemType<ShellstoneLampItem>());
		...
		{
			GlowTexture ??= ModContent.Request<Texture2D>("WaasephisFishingPlus/Content/Tiles/Decor/Furniture/Shellstone/ShellstoneLampGlow");
