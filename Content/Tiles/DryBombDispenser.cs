...
{
    public class DryBombDispenser : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
			...
			if (player.HasItem(ItemID.Bottle))
			{
				...
				Main.LocalPlayer.ConsumeItem(ItemID.Bottle);
				...
				Projectile.NewProjectile(new EntitySource_TileInteraction(player, x * 16, y * 16), SpawnX - 31, SpawnY - 60, 0, -3, ProjectileID.DryBomb, 0, 0, Main.myPlayer);
