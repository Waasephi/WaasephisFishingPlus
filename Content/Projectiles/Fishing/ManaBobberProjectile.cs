...
namespace WaasephisFishingPlus.Content.Projectiles.Fishing
{
    ...
    public class ManaBobberProjectile : ModProjectile
    {
        public static readonly Color[] PossibleLineColors = [
			new Color(145, 155, 231)
		];
		...
		public override void PostAI()
		{
			...
			{
				Dust dust = Dust.NewDustDirect(Projectile.Center, Projectile.width, Projectile.height, DustID.ManaRegeneration);
				dust.noGravity = true;
				dust.scale = 1f;
			}
		}
