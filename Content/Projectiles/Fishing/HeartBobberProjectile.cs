...
namespace WaasephisFishingPlus.Content.Projectiles.Fishing
{
    ...
    public class HeartBobberProjectile : ModProjectile
    {
        public static readonly Color[] PossibleLineColors = [
			new Color(182, 18, 57) // A purple color
		];
		...
		public override void PostAI()
		{
			...
			{
				Dust dust = Dust.NewDustDirect(Projectile.Center, Projectile.width, Projectile.height, DustID.HealingPlus);
				dust.noGravity = true;
				dust.scale = 1f;
			}
		}
