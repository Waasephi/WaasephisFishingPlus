...
namespace WaasephisFishingPlus.Content.Projectiles.Fishing
{
    ...
    public class LifeBobberProjectile : ModProjectile
    {
        public static readonly Color[] PossibleLineColors = [
			new Color(111, 181, 1) // A purple color
		];
		...
		public override void PostAI()
		{
			...
			{
				Dust dust = Dust.NewDustDirect(Projectile.Center, Projectile.width, Projectile.height, DustID.JungleSpore);
				dust.noGravity = true;
				dust.scale = 1f;
			}
		}
