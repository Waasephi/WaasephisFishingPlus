...
{
	public class PotSnailIce : ModNPC
	{
		...
		public override void SetDefaults()
		{
            ...
            NPC.catchItem = (short)ModContent.ItemType<PotSnailIceItem>();
        }

		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			return spawnInfo.Player.ZoneRockLayerHeight && !spawnInfo.Player.ZoneDungeon && spawnInfo.Player.ZoneSnow ? 0.5f : 0f;
		}
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                ModContent.ProjectileType<PotSnailIcePot>(), NPC.damage, 0, NPC.target, 0, 0);
            }
