...
{
	public class PotSnailUG : ModNPC
	{
		...
		public override void SetDefaults()
		{
            ...
            NPC.catchItem = (short)ModContent.ItemType<PotSnailUGItem>();
        }
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                ModContent.ProjectileType<PotSnailUGPot>(), NPC.damage, 0, NPC.target, 0, 0);
            }
