...
{
	public class PotSnailHell : ModNPC
	{
		...
		public override void SetDefaults()
		{
            ...
            NPC.catchItem = (short)ModContent.ItemType<PotSnailHellItem>();
        }

		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			return spawnInfo.Player.ZoneUnderworldHeight && !spawnInfo.Player.ZoneDungeon ? 0.5f : 0f;
		}
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                ModContent.ProjectileType<PotSnailHellPot>(), NPC.damage, 0, NPC.target, 0, 0);
            }
