...
{
    public class SpecularFishCritter : ModNPC
    {
        ...
        {
            return spawnInfo.Water && !spawnInfo.Player.ZoneDesert && (spawnInfo.Player.ZoneNormalUnderground || spawnInfo.Player.ZoneNormalCaverns) ? 0.7f : 0f;
        }
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            [
               BestiaryDatabaseNPCsPopulator.CommonTags.SpawnConditions.Biomes.Underground,
				new FlavorTextBestiaryInfoElement("Mods.WaasephisFishingPlus.Bestiary.SpecularFishCritter"),
			]);
        }
    }
}